...
Server.prototype.out = function () {
  this.exchangeReceiver().use.apply(this.exchangeReceiver(), Array.prototype.slice.call(arguments));
  return this;
};
...
Server.prototype.in = function () {
  this.socketReceiver().use.apply(this.socketReceiver(), Array.prototype.slice.call(arguments));
  return this;
};
