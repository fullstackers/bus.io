...
Server.prototype.exchange = function (exchange) {
  ...
  if (typeof exchange === 'object' && exchange instanceof MessageExchange.Exchange) {
  ...
  if (!this._exchange || (!(typeof this._exchange === 'object' && this._exchange instanceof MessageExchange.Exchange))) {
    this.exchange(MessageExchange.make());
  }
