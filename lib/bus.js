...
function Bus (a) {
  ...
  this.onMessage = function (message, socket) {
    console.log('onMessage', message, socket.id);
  ...
  this.onReceivedExchange = function (message, socket) {
    console.log('onReceivedExchange', message, socket.id);
  ...
  this.onReceivedSocket = function (message, socket) {
    console.log('onReceivedSocket', message, socket.id);
...
Bus.prototype.exchangeReceiver = function (o) {
...
Bus.prototype.socketReceiver = function (o) {
  ...
  console.log('_socketReciver', this._socketReceiver);
  console.log('from socket', this.listeners('from socket'));
