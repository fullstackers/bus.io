...
Router.prototype.route = function (message, done) {/* done() is for testing */
  ...
  debug('is an instanceof of array? %s how about Message? %s', message instanceof Array, message instanceof Message);
  if (!(message instanceof Array) && !(message instanceof Message)) throw new Error('message must be a Message');
